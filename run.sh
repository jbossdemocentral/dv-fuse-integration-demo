...
echo "=          profile-edit                                                                   ="
echo "=   --bundles wrap:file:///<install-dir>/teiid-8.4.1-redhat-7-jdbc.jar dvfusedemo 1.0     ="
echo "=      where install-dir =                                                                =" 
echo "=        <dir>/dv-fuse-integration-demo/target/dv/jboss-eap-6.1/dataVirtualization/jdbc   ="
echo "=    - create container name c1 and add usecase1 and jboss-fuse-minimal profile           ="
echo "=      or use the following command in the bin/admin shell                                ="
echo "=          fabric:container-create-child --profile usecase1                               ="
